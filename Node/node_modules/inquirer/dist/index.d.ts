...
import PromptsRunner from './ui/prompt';
import type { PromptCollection, LegacyPromptConstructor, PromptFn } from './ui/prompt';
import type { Answers, StreamOptions, QuestionMap, PromptSession, PromptModulePublicQuestion, PromptModuleSpecificQuestion, PromptModuleNamedQuestion, QuestionSequence, MergedAnswers, DictionaryAnswers } from './types';
...
export type { QuestionMap, Question, DistinctQuestion, Answers, PromptSession, } from './types';
